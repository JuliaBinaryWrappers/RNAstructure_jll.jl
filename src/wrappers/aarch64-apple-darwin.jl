# Autogenerated wrapper script for RNAstructure_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libRNAstructure, "@rpath/libRNAstructure.dylib")
